all: progetto.md 
	pandoc --listing --pdf-engine=xelatex -H head.tex -f markdown+implicit_figures -V geometry:"top=3.7cm, bottom=3.7cm, left=4cm, right=4cm" progetto.md -o progetto.pdf -V toc -V mmd_header_identifiers
